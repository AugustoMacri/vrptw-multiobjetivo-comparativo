#!/bin/bash
# =============================================================================
# GERA MAPAS PADRONIZADOS DAS ROTAS (NSGA-III)
# =============================================================================
# Itera por todos os evo_*.txt em results/ e gera 1 PNG por execucao em:
#   results/<categoria>/<instancia>/maps/map_nsga3_<inst>_exec<N>.png
# =============================================================================
...
generate_for_category() {
    ...
    for inst_dir in "$cat_dir"/*/; do
        ...
        for evo_file in "$inst_dir"evo_*.txt; do
            ...
            local out_png="$maps_dir/map_nsga3_${inst_lower}_exec${exec_num}.png"
