...
# Script para executar todas as instâncias C1 com NSGA-III (10 vezes cada)
# Uso: ./run_validation_nsga3_c1.sh

echo "=========================================="
echo "Executor de Validação NSGA-III - C1"
echo "=========================================="
echo ""
...
# Instâncias C1: de 1 a 9 (C101 a C109)
INSTANCES=(1 2 3 4 5 6 7 8 9)
INSTANCE_NAMES=("C101" "C102" "C103" "C104" "C105" "C106" "C107" "C108" "C109")
...
echo "  2. Gerar mapas: ./generate_route_maps_nsga3.sh all_c1"
