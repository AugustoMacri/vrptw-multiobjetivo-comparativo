#!/usr/bin/env python3
"""
Script para validação do algoritmo AEMMT nas instâncias R101-R109.
Executa 10 vezes cada instância e armazena resultados em results_validation_R1/.
...
RESULTS_BASE_DIR = PROJECT_ROOT / 'results_validation_R1'
BIN_DIR = PROJECT_ROOT / 'bin'
RESULTS_MULTI_DIR = PROJECT_ROOT / 'resultsMulti'

# Instâncias R1 (R101 até R109)
INSTANCES = {
    'R101': 18,
    'R102': 19,
    'R103': 20,
...
def run_validation():
    """Executa validação completa para todas as instâncias R1."""
    print("\n" + "=" * 60)
    print("VALIDAÇÃO AEMMT - INSTÂNCIAS R1 (R101-R109)")
    print("=" * 60 + "\n")
