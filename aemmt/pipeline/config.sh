#!/bin/bash
# =============================================================================
# CONFIGURACAO CENTRALIZADA DO PIPELINE AEMMT
# =============================================================================
...
export ALGO_NAME="AEMMT"
export ALGO_DESC="Algoritmo Evolutivo Multiobjetivo com Multiplas Tabelas"
...
export INSTANCES_DIR="src/instances/solomon"       # Onde estao os .txt das instancias
export BIN_DIR="bin"                                # Onde fica o bytecode compilado
export SRC_DIR="src"                                # Codigo-fonte Java

# --- Diretorio intermediario do Java (criado pelo proprio main.App) ---
export JAVA_OUTPUT_DIR="resultsMulti"
...
check_dependencies() {
    ...
    if ! command -v javac &> /dev/null; then
        log_error "javac nao encontrado no PATH"
        missing=1
    fi
    ...
    log_ok "Dependencias verificadas (java, javac, $PYTHON_CMD)"
    return 0
}
